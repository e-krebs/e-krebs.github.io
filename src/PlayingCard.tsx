...
const CardShell: FC<PropsWithChildren<CardShellProps>> = ({ children, className, onClick }) => (
  <section
    className={cx(
      className,
...
export const CardFront: FC<PropsWithChildren<CardProps>> = ({
  children,
  icon: Icon,
  className,
  onClick,
}) => (
  <CardShell className={className} onClick={onClick}>
    <svg
      stroke="white"
      fill="currentColor"
      strokeWidth="0"
